<script>
  ...
  function clearAllStorage() {
    const ok = confirm(
      "Clear all local storage? This removes your settings, bookmarks, and AI sessions, plus anything sites you've visited through GameTFM have stored here. This can't be undone.",
    );
    if (!ok) return;
    ...
    <div class="group">
      ...
      <div class="card">
        ...
        <div class="row">
          <div class="label">
            <b>about:blank</b>
            <small>Reopen GameTFM inside a blank window.</small>
          </div>
